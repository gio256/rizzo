...
fn eval_load<P: PackedField>(
    ...
    cc.constraint(f_lw * (lv.rs1 - ch_rs1.adr_virt));
    ...
    cc.constraint(f_lw * (lv.rd - ch_rd.adr_virt));
...
fn eval_store<P: PackedField>(
    ...
    cc.constraint(f_sw * (lv.rs1 - ch_rs1.adr_virt));
    ...
    cc.constraint(f_sw * (lv.rs2 - ch_rs2.adr_virt));
